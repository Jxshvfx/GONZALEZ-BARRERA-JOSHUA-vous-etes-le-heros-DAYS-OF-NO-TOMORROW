let chapters = {
    debut: {
        ...
        boutons: [{
            ...
            destination: 'goToChapter("infiltration")'
        },]  
    },
    infiltration: {
        titre: "Infiltration",
        ...
        boutons: [{
            ...
            destination: "goToChapter('discretion')"
        }, {
            titre: "Infiltrer Explosivement",
            destination: "goToChapter('explosion')"
        }]
    },
    ...
    explosion: {
        ...
        boutons: [{
            titre: 'Continuez',
            destination: "goToChapter('choixDifficile')"
        }]
    },
    ...
    choixDifficile: {
        ...
        boutons: [{
            ...
            destination: "goToChapter('alterer')"
        }, {
            titre: "Ne rien faire",
            destination: "goToChapter('rienFaire')"
        }]
    },
    ...
    rienFaire: {
        ...
        boutons: [{
            titre: "Continuer",
            destination: "goToChapter('escapade')"
        }]
    },
    ...
    escapade: {
        ...
        boutons: [{
            ...
            destination: "goToChapter('artMartiaux')"
        }, {
            titre: "Utiliser Pistolet",
            destination: "goToChapter('pistolet')"
        }, {
            titre: "Vous échappez et ne rien faire",
            destination: "goToChapter('echappez')"
        }]
    },
    ...
    artMartiaux: {
        ...
        boutons: [{
            titre: "Continuer",
            destination: "goToChapter('endgame')"
        }]
    },
    ...
    endgame: {
        ...
        boutons: [{
            titre: "Je l'ai sauvé",
            destination: "goToChapter('sauvez')"
        }, {
            titre: "Je ne l'ai pas sauvé",
            destination: "goToChapter('pasSauvez')"
        }, {
            titre: "Deuxième Chance",
            destination: "goToChapter('deuxiemeChance')"
        }]
    },
    ...
    deuxiemeChance: {
        ...
        boutons: [{
            titre: "Se sacrifier",
            destination: "goToChapter('sacrifice')"
        }, {
            titre: "Ne pas se sacrifier",
            destination: "goToChapter('pasSacrifice')"
        }]
    },
...
document.getElementById('paragraphe').innerHTML = chapters.debut.description;